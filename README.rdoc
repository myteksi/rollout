...
This is a fork of the original rollout gem at FetLife/rollout. 

The current version of rollout that serializes and deserializes strings on every call causes performance issue with my use cases and I do not need support for multiple different storage mechanisms.
